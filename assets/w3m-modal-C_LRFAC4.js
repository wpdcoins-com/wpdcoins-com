import{p as ve,i as fe,s as ge,j as be,R as l,M as g,S as se,k as v,l as P,m as f,x as a,A as K,n as ce,o as le,C as m,q as Y,u as ye,v as S,E as ie,O as E,y as q,z as oe,B as T,D as H,T as xe,F as Ce,G as ke,I as Se}from"./core-CxXsumDy.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-Dlhhi_uk.js";import"./index-B02C1K1i.js";import"./events-D1cw_0Mp.js";import"./index.es-DBvyA2Om.js";import"./index-nibyPLVP.js";const p=ve({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return ge(p,()=>r(p))},subscribeKey(r,e){return be(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=fe(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
